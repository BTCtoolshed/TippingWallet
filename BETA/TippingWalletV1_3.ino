...
//NEW: print/no print options and a hidden OTP printer
...
printer.println(OTPLine); printer.println(OTPLine); //do this twice
OTPLine = "";
...
//printer.feed();
//printer.feed();
//qrcode_initText(&qrcode, qrcodeBytes, qrVersion, qrErrorLevel, "https://youtube.com/playlist?list=PLeCDOgYLRFiqmPM9VbozAc2_RJDENr70A&si=dGiV8UIWp0fnp7NI");
